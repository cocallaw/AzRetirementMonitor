...
.OUTPUTS
PSCustomObject[]
Each object contains: SubscriptionId, ResourceId, ResourceName, ResourceType, ResourceGroup,
Category, Impact, Problem, Solution, Description, LastUpdated, IsRetirement, RecommendationId,
LearnMoreLink, ResourceLink.
.EXAMPLE
